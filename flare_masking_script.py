...
filename = '/Users/coletamburri/Desktop/August_2024_DKIST_Flares/8AugXclass_caII_hep_bkgdsub.npz'
...
frame_hbeta0, mask0, km0, normprofiles_hbeta0, groups0, x_mask0, y_mask0 = \
...
arr_normprofs0 = normprofiles_hbeta0
...
ax.pcolormesh(np.transpose(frame_hbeta0),cmap = 'hot',alpha=0.5)
